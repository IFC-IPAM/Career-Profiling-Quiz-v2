          ...
          <Card className="border-2 border-primary">
            ...
            <CardContent className="text-center px-6">
              <p className="text-foreground/80 text-base">
                Ready to understand your career development style? Take this quick quiz to uncover your strengths across the 4As (Agility, Agency, Alignment & Adaptability) and discover strategies that match your unique career profile.
              </p>
            </CardContent>
          </Card>
